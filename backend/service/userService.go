...
func (service *UserService) UserRegister(username string, password string) error {
...
func (service *UserService) UserLogin(username string, password string) (string, error) {
	...
	// TODO: use uuid to generate jwt token
